  ...
  return (
    <main className="overflow-auto p-3 w-full">
      <motion.div layout layoutRoot className="flex flex-wrap gap-3">
        <motion.div
          onClick={() => router.push('/note/createNote')}
          layoutId="createNote"
          className="flex flex-col justify-center items-center p-4 gap-3 h-72 w-80 cursor-pointer bg-box-secondary-light dark:bg-box-secondary-dark rounded-2xl"
        >
